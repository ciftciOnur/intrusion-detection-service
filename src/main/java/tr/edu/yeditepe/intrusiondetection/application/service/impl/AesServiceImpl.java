...
public class AesServiceImpl implements AesService{
	...
	@Override
	public String encrypt(String algorithm, String input, SecretKey key, byte[] aesIv) throws NoSuchPaddingException, NoSuchAlgorithmException,
	...
	@Override
	public String decrypt(String algorithm, String cipherText, SecretKey key, byte[] aesIv) throws NoSuchPaddingException, NoSuchAlgorithmException,
		    InvalidAlgorithmParameterException, InvalidKeyException,
		    BadPaddingException, IllegalBlockSizeException {
